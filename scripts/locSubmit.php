...
include 'locationSubView.php';			//script for viewing submission summary
...
include 'PHPMailer/email1.php';			//PHPMailer library
	...
	if(isset($_POST['EMAIL'])){			//store email if provided
		...
		VALUES ('$guidename', '$datee', '$postcode',  '$age', '$email', '$filename','location')";
		$result = mysqli_query($dbCon, $sql);
		}
		
		else{
		$sql="INSERT INTO submission (guide_name, date, postcode, age, submission,guide_type)
		VALUES ('$guidename', '$datee', '$postcode',  '$age', '$filename','location')";
		$result = mysqli_query($dbCon, $sql);}
