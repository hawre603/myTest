		   ...
		   <head>
			...
			<div class='DivTwo'>
					...
					<div>
						...
						<form style='text-align:left' enctype='multipart/form-data' data-ajax='false' action='scripts_Locguide/uploadXmLocScript.php' method="POST" onsubmit="return confirm('Are you sure you want to perform this action?');">
							<label  for="file">Choose XML file:</label>
							<input type="file" id='file' name="file">
							<input type="text"  name="title" required>
							<input type="submit" name='submit' value='Upload XML file'>
						</form> 
					</div>
