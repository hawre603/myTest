...
<!DOCTYPE html>
   ...
   <body>
        ...
        <div  class='DivOne'>
			<div  class='myHeda'>
				Location Guides Management System	
			</div>
		</div>
       ...
       <div data-role="content">
			<div class='DivTwo'>
				<div class='DivThree'>
					...
					<li> <a href="createLocGuide.php" data-ajax='false'><img src="../icons/map_icon.png" alt='thumbnail'/>Create Location Map Guides</a></li>
					</ul>
					<ul data-role='listview' data-inset='true'>
						<li> <a href="manageLocactionguide.php" data-ajax='false'><img src="../icons/manage_location.jpeg" alt='thumbnail'/>Edit/Delete Location Gudes </a></li>
					</ul>
					<ul data-role='listview' data-inset='true'>
						<li> <a href='locBrowseguides.php' data-ajax='false'><img src='../icons/browse.png' alt='thumbnail'/>Browse Location Guides</a></li>
					</ul>
                    <ul data-role='listview' data-inset='true'>
					<li> <a href='uploadXmLocation.php' data-ajax='false'><img src='../icons/import_export_xml_icon.jpg' alt='thumbnail'/>Upload XML file</a></li>
					</ul>
					<ul data-role='listview' data-inset='true'>
						<li> <a href='downLocguidexml.php' data-ajax='false'><img src ='../icons/import_export_xml_icon.jpg' alt='thumbnail'/>Download XML file</a></li> 
					</ul>
				</div>
			</div>
		</div>
