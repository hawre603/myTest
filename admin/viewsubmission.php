   ...
   <head>
	...
	<div  class='DivOne'>
		...
		<?php
			...
			$fname="xmlsubmissions/".$gd."/".$name.".xml";
			...
			while ($xml->read()) {
					...
					if ($xml->nodeType == XMLReader::ELEMENT) {
						...
						if (strpos($xml->name,'guide') !== false) {
							echo "<tr><td style='background-color:#BBAE3C; padding:5px; font-family: cursive; text-align:center'>                            Questionaire:";		
							continue;
							}
						...
						if (strpos($xml->name,'Que') !== false) {
							$xml->read();
							if(($xml->value)!=""){
							echo "<tr style='background-color:#EBE5C5'><td style='padding:5px; font-family: verdana'>";print $xml->value; 
								echo" </td></tr>";
							continue;}
							}
						...
						if (strpos($xml->name,'POSTCODE') !== false) {	
							echo "<tr style='background-color:#BBAE3C;'><td style='padding:5px; font-family: cursive; text-align:center'>                            Postcode:";		
							continue;
							}
						
						if (strpos($xml->name,'AGE') !== false) {	
							echo "<tr style='background-color:#BBAE3C;'><td style='padding:5px; font-family: cursive; text-align:center'>                            Age:";		
							continue;
							}
