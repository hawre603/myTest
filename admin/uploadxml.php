		   ...
		   <head>
			...
			<div class='DivTwo'>
					...
					<div>
						...
						<form style='text-align:left' enctype='multipart/form-data' data-ajax='false' action='scripts/uploadxmlscript.php' method="POST" onsubmit="return confirm('Are you sure you want to perform this action?');">
