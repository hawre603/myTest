...
<!DOCTYPE html>
   ...
   <body>
		...
		<div id="loginDiv1">
			<div id="loginDiv2">
				An error has caused the requested page to fail loading, you may have pressed back, forward or refresh. Pleas use the navigation buttons provided on the navigation bar of each page instead.
			</div>
		</div>
        </body>
        </html>