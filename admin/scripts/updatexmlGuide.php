		...
		include 'updateGuiderecord.php'; //script that add guide to database table for guides
		...
		//echo'option'.$i, $_POST["option".$i.$counta].'<br>'; 
		}
		}
		}
		...
		printf("<script>alert('The guide has been updated successfully!!');location.href='../Home.php'</script>");
		}
		}
