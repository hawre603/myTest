    ...
    $(this).parent('li').remove(); });
         ...
         <div  data-role='content' style="width:85%; background-color:#FFF; margin:0 auto" >
				...
				echo"<input type='hidden' name='fileName' value='".$_POST['editSelectedGuide']."'>";
		   	   if (file_exists('../xmlpages/hawreGuide2014031701.xml')) 
			   {       
			         $xml = simplexml_load_file('../xmlpages/'.$_POST['editSelectedGuide'].'.xml');
				} else {   
			...
			echo"<input type='button' class='remove' value='remove'></li>"; 
             ...
             <div id="responsecontainer" style="font-family:Arial, Helvetica, sans-serif; color:#EEE; background-color:#B3D4FD" align="center"> </div>
