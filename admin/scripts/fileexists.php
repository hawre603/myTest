...
<!DOCTYPE html>
   <head>
        ...
        <link rel='stylesheet' type='text/css' href='cmsStyling.css'/>
   ...
   <body>
		...
		<div data-role="navbar">
			<ul>
				<li><a href="adminmanagement.php">Back</a></li>
		...
		<div id="loginDiv1">
			<div id="loginDiv2">
				The selected file already exits, it may be sharing the same name or title with an existing file.
			</div>
		</div>
        </body>
        </html>